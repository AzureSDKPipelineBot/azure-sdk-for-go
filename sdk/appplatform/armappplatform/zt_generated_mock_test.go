...
func TestServices_Get(t *testing.T) {
	...
	client := NewServicesClient("00000000-0000-0000-0000-000000000000", cred, &options)
...
func TestConfigServers_Get(t *testing.T) {
	...
	client := NewConfigServersClient("00000000-0000-0000-0000-000000000000", cred, &options)
	res, err := client.Get(ctx,
		"myResourceGroup",
		"myservice",
...
func TestMonitoringSettings_Get(t *testing.T) {
	...
	client := NewMonitoringSettingsClient("00000000-0000-0000-0000-000000000000", cred, &options)
	res, err := client.Get(ctx,
		"myResourceGroup",
		"myservice",
...
func TestApps_Get(t *testing.T) {
	...
	client := NewAppsClient("00000000-0000-0000-0000-000000000000", cred, &options)
	res, err := client.Get(ctx,
		"myResourceGroup",
		"myservice",
		"myapp",
...
func TestBindings_Get(t *testing.T) {
	...
	client := NewBindingsClient("00000000-0000-0000-0000-000000000000", cred, &options)
	res, err := client.Get(ctx,
		"myResourceGroup",
		"myservice",
		"myapp",
...
func TestCertificates_Get(t *testing.T) {
	...
	client := NewCertificatesClient("00000000-0000-0000-0000-000000000000", cred, &options)
	res, err := client.Get(ctx,
		"myResourceGroup",
		"myservice",
		"mycertificate",
...
func TestCustomDomains_Get(t *testing.T) {
	...
	client := NewCustomDomainsClient("00000000-0000-0000-0000-000000000000", cred, &options)
	res, err := client.Get(ctx,
		"myResourceGroup",
		"myservice",
		"myapp",
...
func TestDeployments_Get(t *testing.T) {
	...
	client := NewDeploymentsClient("00000000-0000-0000-0000-000000000000", cred, &options)
	res, err := client.Get(ctx,
		"myResourceGroup",
		"myservice",
		"myapp",
...
func TestOperations_List(t *testing.T) {
	...
	client := NewOperationsClient(cred, &options)
...
func TestRuntimeVersions_ListRuntimeVersions(t *testing.T) {
	...
	client := NewRuntimeVersionsClient(cred, &options)
...
func TestSkus_List(t *testing.T) {
	...
	client := NewSKUsClient("00000000-0000-0000-0000-000000000000", cred, &options)
