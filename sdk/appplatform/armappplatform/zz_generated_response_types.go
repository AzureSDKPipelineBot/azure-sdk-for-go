...
func (l *AppsCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *AppsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("AppsClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &AppsCreateOrUpdatePoller {
...
func (l *AppsDeletePollerResponse) Resume(ctx context.Context, client *AppsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("AppsClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &AppsDeletePoller {
...
func (l *AppsUpdatePollerResponse) Resume(ctx context.Context, client *AppsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("AppsClient.Update", token, 	client.pl, client.updateHandleError)
	if err != nil {
		return err
	}
	poller := &AppsUpdatePoller {
...
func (l *BindingsCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *BindingsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("BindingsClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &BindingsCreateOrUpdatePoller {
...
func (l *BindingsDeletePollerResponse) Resume(ctx context.Context, client *BindingsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("BindingsClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &BindingsDeletePoller {
...
func (l *BindingsUpdatePollerResponse) Resume(ctx context.Context, client *BindingsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("BindingsClient.Update", token, 	client.pl, client.updateHandleError)
	if err != nil {
		return err
	}
	poller := &BindingsUpdatePoller {
...
func (l *CertificatesCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *CertificatesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("CertificatesClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &CertificatesCreateOrUpdatePoller {
...
func (l *CertificatesDeletePollerResponse) Resume(ctx context.Context, client *CertificatesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("CertificatesClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &CertificatesDeletePoller {
...
func (l *ConfigServersUpdatePatchPollerResponse) Resume(ctx context.Context, client *ConfigServersClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("ConfigServersClient.UpdatePatch", token, 	client.pl, client.updatePatchHandleError)
	if err != nil {
		return err
	}
	poller := &ConfigServersUpdatePatchPoller {
...
func (l *ConfigServersUpdatePutPollerResponse) Resume(ctx context.Context, client *ConfigServersClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("ConfigServersClient.UpdatePut", token, 	client.pl, client.updatePutHandleError)
	if err != nil {
		return err
	}
	poller := &ConfigServersUpdatePutPoller {
...
func (l *ConfigServersValidatePollerResponse) Resume(ctx context.Context, client *ConfigServersClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("ConfigServersClient.Validate", token, 	client.pl, client.validateHandleError)
	if err != nil {
		return err
	}
	poller := &ConfigServersValidatePoller {
...
func (l *CustomDomainsCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *CustomDomainsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("CustomDomainsClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &CustomDomainsCreateOrUpdatePoller {
...
func (l *CustomDomainsDeletePollerResponse) Resume(ctx context.Context, client *CustomDomainsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("CustomDomainsClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &CustomDomainsDeletePoller {
...
func (l *CustomDomainsUpdatePollerResponse) Resume(ctx context.Context, client *CustomDomainsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("CustomDomainsClient.Update", token, 	client.pl, client.updateHandleError)
	if err != nil {
		return err
	}
	poller := &CustomDomainsUpdatePoller {
...
func (l *DeploymentsCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *DeploymentsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("DeploymentsClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &DeploymentsCreateOrUpdatePoller {
...
func (l *DeploymentsDeletePollerResponse) Resume(ctx context.Context, client *DeploymentsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("DeploymentsClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &DeploymentsDeletePoller {
...
func (l *DeploymentsRestartPollerResponse) Resume(ctx context.Context, client *DeploymentsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("DeploymentsClient.Restart", token, 	client.pl, client.restartHandleError)
	if err != nil {
		return err
	}
	poller := &DeploymentsRestartPoller {
...
func (l *DeploymentsStartPollerResponse) Resume(ctx context.Context, client *DeploymentsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("DeploymentsClient.Start", token, 	client.pl, client.startHandleError)
	if err != nil {
		return err
	}
	poller := &DeploymentsStartPoller {
...
func (l *DeploymentsStopPollerResponse) Resume(ctx context.Context, client *DeploymentsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("DeploymentsClient.Stop", token, 	client.pl, client.stopHandleError)
	if err != nil {
		return err
	}
	poller := &DeploymentsStopPoller {
...
func (l *DeploymentsUpdatePollerResponse) Resume(ctx context.Context, client *DeploymentsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("DeploymentsClient.Update", token, 	client.pl, client.updateHandleError)
	if err != nil {
		return err
	}
	poller := &DeploymentsUpdatePoller {
...
func (l *MonitoringSettingsUpdatePatchPollerResponse) Resume(ctx context.Context, client *MonitoringSettingsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("MonitoringSettingsClient.UpdatePatch", token, 	client.pl, client.updatePatchHandleError)
	if err != nil {
		return err
	}
	poller := &MonitoringSettingsUpdatePatchPoller {
...
func (l *MonitoringSettingsUpdatePutPollerResponse) Resume(ctx context.Context, client *MonitoringSettingsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("MonitoringSettingsClient.UpdatePut", token, 	client.pl, client.updatePutHandleError)
	if err != nil {
		return err
	}
	poller := &MonitoringSettingsUpdatePutPoller {
...
func (l *ServicesCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *ServicesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("ServicesClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &ServicesCreateOrUpdatePoller {
...
func (l *ServicesDeletePollerResponse) Resume(ctx context.Context, client *ServicesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("ServicesClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &ServicesDeletePoller {
...
func (l *ServicesUpdatePollerResponse) Resume(ctx context.Context, client *ServicesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("ServicesClient.Update", token, 	client.pl, client.updateHandleError)
	if err != nil {
		return err
	}
	poller := &ServicesUpdatePoller {
